...
# Changes
# - Make gensz param optional
# - Add tempdir to macs2 callpeak
# - Add output prefix
...
def macs2_signal_track(ta, chrsz, gensz, pval_thresh, smooth_win, out_dir, prefix=None):
    if prefix is None:
...
def main():
    ...
    fc_bigwig, pval_bigwig = macs2_signal_track(
        ...
        args.smooth_win, args.out_dir, args.output_prefix)
